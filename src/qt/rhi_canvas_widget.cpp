...
// we force initialization once via a file-scope static. The shader QRC
// is always generated by CMake into ${build}/ezgl_rhi_shaders.qrc — there
// is no fallback to a committed QRC; qsb is a hard build requirement.
